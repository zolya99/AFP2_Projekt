                ...
                <div class="fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <ul class="list-inline">
                            <li><a href="{{ url('/home') }}" class="lead">Kezdőlap</a></li>
                            <li><a  href="{{ route('logout') }}" class="lead"
                    ...
                    @else
                        <ul class="list-inline">
                            <li class="list-inline-item"><a href="{{ route('login') }}" class="lead">Bejelentkezés</a></li>
                            @if (Route::has('register'))
                                <li class="list-inline-item"><a href="{{ route('register') }}" class="lead">Regisztráció</a></li>
                        </ul>
                            @endif
                    @endauth
                </div>
